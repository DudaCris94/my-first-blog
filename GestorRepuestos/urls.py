"""GestorRepuestos URL Configuration
...
urlpatterns = [
    ...
    url(r'^repuesto/', include ('apps.repuesto.urls', namespace="repuesto")),
    url(r'^responsable/', include ('apps.responsable.urls', namespace="responsable")),
